...
class RobotData {
  ...
  private String[] juncHeading; //heading of the robot when it first arrived in the junction

  RobotData(){ //We dont need the coordiantes anymore
  ...
  */
  ...
  public void printJunction(){ //prints the junction along with the heading of the robot when it first entered the junction
    System.out.println("Junction " + junctionCounter + " heading=" + juncHeading[junctionCounter]);
  }

  public String searchJunction(IRobot robot){ //Searches for the last function in the array and returns the heading
    return juncHeading[junctionCounter];
  }

  public void removeJunction(IRobot robot){ //removes the last junction beacuse we dont need it anymore
    juncHeading[junctionCounter] =juncHeading[junctionCounter+1];
